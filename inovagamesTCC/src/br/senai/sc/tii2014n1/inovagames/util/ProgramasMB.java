...
@ManagedBean
@ViewScoped
public class ProgramasMB implements Serializable{
	...
	public  void escolherPrograma(int nMetodo) {
		switch (nMetodo){
	        case 1:
	            calculoMedia();
	            break;
	...
	public   String impressaoNotaSuper(List<Supermercado> listaSuper, int tipoPagamento, int nParcela, float totalCompra, float valorParcela, int formaPagamento) {
